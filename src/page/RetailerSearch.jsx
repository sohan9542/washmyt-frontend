  ...
  return (
    <div className=" mt-5 px-3 lg:px-0 min-h-[900px]">
      {!load ? (
        <div className="px-7  mx-auto">
          ...
          <form
            ...
            className={` grid grid-cols-1 ${
              modelcategory.length !== 0 ? "lg:grid-cols-10" : "lg:grid-cols-7"
            } gap-2 lg:gap-5`}
          >
            ...
            <div className="lg:col-span-3">
              ...
              >
                ...
                {makecategory.map((item, ind) => (
                  <option key={ind} value={item} className=" capitalize">
                    {item}
                  </option>
                ))}
              </select>
        ...
        <div className=" h-full flex min-h-screen items-center text-xl font-semibold justify-center">
          Loading...
        </div>
      )}
    </div>
